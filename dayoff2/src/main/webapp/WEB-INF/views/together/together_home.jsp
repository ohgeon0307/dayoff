...
<body>
  <header>
    <section class="first_section">
      <div class="header">
        ...
        <div class="right_header">
          ...
          <a href="together_board_write.html"><button class="header_write_btn">글쓰기</button></a>
        </div>
      </div>
    ...
    <main class="LayoutItem" id="contents" style="background-color:rgb(248,248,248); padding-bottom:320px;">
        ...
        <div class="LayoutContentWrap">
            <section direction="vertical" class="WebSection" style="margin-top: 65px;">
                        ...
                        <div class="WebSetionArea">
                            <div class="FilterItem">
                                <div class="filterCountry">
                                    <div>
                                        <div>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">서울
                                            </button>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">강원도
                                            </button>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">제주도
                                            </button>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">부산
                                            </button>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">경기도
                                            </button>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">인천
                                            </button>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">충청도
                                            </button>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">경상도
                                            </button>
                                            <button width="auto" font-size="15px" font-weight="400" class="ButtonToggle" 
                                            style="width:fit-content; justify-content:flex-start;">전라도
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            <section direction="vertical" class="WebSection" style="margin-top:65px;">
                <div class="WebSectionArea">
                    <button width="auto" font-size="16px" font-weight="700" class="ButtonWrapper"
                    style="border-radius:30px;">모집중인 글만 보기</button>
                    <div class="SelectItem" style="width:82px; height:37px; padding: 0 7px; margin: 0 10px 0 0;">
                ...
                <ul class="Accompany" type="portrait">
                    <div type="portrait" class="AccompanyItem">
                        <div>
                            <img src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMjExMjNfOTIg%2FMDAxNjY5MjA5NDM2NTEw.KeZsQi4hUkXYgwKV--nko3c2H3rBF15ayWYiU8U31v0g.kjSfkyN_ovdKSRbRRHIzWme4xCnn8Jv1Za4SpBAjuzEg.JPEG.leegh1224%2FL7R06739.jpg&type=sc960_832" alt="배경사진">
                        ...
                        <div class="ContentWrapper" type="portrait">
                            <div class="TitleWrapper">
                                ...
                                "1/19~23 부분동행으로 재밌게 놀 분 구해요~"
                            </div>
                            <p type="portrait" class="DescWrapper">"현재 저 혼자고 19~21, 22~23사이에 놀 수 있는 분 구하면 좋겠어요~"</p>
                            <div class="ViewWrapper">
                                <div font-size="16px;" class="ProfileWrapper">
                                    <img src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMjEyMzFfMTg3%2FMDAxNjcyNDUxMDI1NTE1.VLx626NrysZ3NOZkloI0gsuuuJTxd923KppKsuE4mfYg.CsnHVbqztSzOHmooQ4uVOq3wcEOwZ84NKcnHX55fnJQg.JPEG.qhrjtmhey%2FScreenshot_2022-12-31_at_10.43.00.JPG&type=sc960_832" alt="프로필">
                                    <div>
