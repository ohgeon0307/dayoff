...
<body>
    ...
    <main class="CommunityView">
        <section direction="vertical" class="Websection">
            <img src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMjA0MTBfMjA2%2FMDAxNjQ5NTc2NjAwMzAw.xvX0E-akmVI2YX9j_p1i_x3XRIN8pquIf-UoiFpfkIMg.vmBH_2owoAvDtLsrM9pEAPrsDit_p4hpj65Bd9viOF4g.JPEG.s7815947%2FDSC_7041_%25BA%25B9%25BB%25E7.jpg&type=sc960_832" alt="이미지">
        </section>
                ...
                <div class="AccompanyContainer">
                    ...
                    <div class="AccompanyContainer_TopInfoBox">
                        ...
                        <div class="AccompanyContainer_MarginBox">
                            <div class="AccompanyContainer_FlexBox">
                                <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:inline-block">
                    ...
                    <div class="AccompanyContainer_TempWrap">
                        <div class="AccompanyContainer_TempWrap1">
                            <svg width="15" heigth="15" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="AccompanyContainer_ContentBox">1. 동행 성별:  무관 (여성분이시라면 숙소쉐어하고 싶어요!) 
                        2. 동행 나이:  25-33 (제가 20후라 너무 어리거나 많으면 서로 불편할거 같아 나이제한 둡니다)
                        27일은 오후 3-4시 이후부터만 가능합니다
                        3. 부분동행 가능합니다 
                        ex) 교토만 동행, 27일 저녁식사만 함께
                        4. 선호하는 스타일: 계획적인 분
                         약속 잘 지키시는 분. 예전에 뉴욕동행 구할때 당일파토/전날파토 당해봐서 이런분은 거절이요
                        5. 현재 계획
                        거의 무계획이나 다름없어서 짜신계획 있으시면 맞춰드리고 아니면 같이 계획해보겠습니다
                        6. 기타
                        ☆☆☆☆☆☆스시 못먹습니다☆☆☆☆☆☆☆
                        익힌 해산물은 먹어요
                        유니버셜 스튜디오는 아직 미정이라(안갈확률 높) 유니버셜 동행 찾으시는 분은 거절할게요ㅠㅠ
                    </p>
                    <div class="badge_HashTag">
                        <div>
                            <div class="badge_HashTag1">
                                <div>
                                    <div class="badge_HashTag2" font-size="13px" font-weight="500">
                                        <p class="HashTag">
                                            #
                                        </p>
                                        <p class="HashTag">
                    ...
                    <div class="AccompanyContainer_BottomBox">
                        ...
                        <button class="AccompanyContainer_ReportButton">
                            신고하기
                        </button>
                    </div>
                    <div class="AccompanyContainer_InputBox">
                        <div class="CommentInputBox">
                            <textarea placeholder="댓글을 입력해주세요." class="CommentInputBox_Input" style="height:39px;">
                                    ...
                                    <div class="Comment_UserImg">
                                        <div class="ShimmerImg">
                                            <div class="ShimmerImg1">
                                                <img class="ShimmerImg2" src="img/캡처.jpg" alt="프로필사진">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="Area_Middle">
                        <div class="Profile_click">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18Z" fill="#00CE7C">

                                </path>
                                <path d="M7.77467 12.9015C7.78623 12.6612 7.86817 12.4295 8.01029 12.2353C8.15241 12.0411 8.34846 11.893 8.57407 11.8093C8.79968 11.7256 9.04491 11.71 9.27931 11.7645C9.5137 11.8189 9.72691 11.9411 9.89247 12.1157C10.058 12.2904 10.1686 12.5098 10.2105 12.7468C10.2524 12.9838 10.2237 13.2278 10.1281 13.4486C10.0324 13.6695 9.87403 13.8573 9.67253 13.9888C9.47102 14.1204 9.23531 14.1898 8.99467 14.1885C8.82916 14.1871 8.66563 14.1523 8.51386 14.0863C8.36209 14.0202 8.22519 13.9243 8.11132 13.8042C7.99745 13.684 7.90896 13.5422 7.85111 13.3871C7.79327 13.232 7.76727 13.0669 7.77467 12.9015ZM8.06967 5.67455L8.00267 3.81055H9.98667L9.91967 5.67455L9.63767 10.6215H8.35167L8.06967 5.67455Z" fill="white"></path>
                            </svg>
                            <p class="ProfileCompanion">프로필 사진을 클릭해보세요!</p>
                        </div>
                        <div class="ButtonWrapper">
                            <button class="ButtonStyle" width="268px" height="55px" font-style="button">
                                <a>동행 신청하기</a>
                            </button>
                        </div>
                    </div>
