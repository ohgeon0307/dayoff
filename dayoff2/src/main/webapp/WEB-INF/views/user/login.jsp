    ...
    <section class="first_section">
      ...
      <section class="second_section">
        <div class="second_header">
          ...
          <a href="${path }/board/list.do"><div class="board">게시판</div></a>
        </div>
      </section>
    </section>
</header>
    <div class="joinFrame">
        <div class="join">
            ...
            <button class="btn_join join_kakao">
                <a class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=5b665dada62338c2ffc08d6bf5298ed4&redirect_uri=http://192.168.0.137:8099/dayoff/kakao/kakao.do&response_type=code"><p>카카오로 간편 로그인</p></a>
            </button>
