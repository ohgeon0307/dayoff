...
<body>
			...
			<div class="header">
				<div class="left_header">
					...
					<a href="<%=request.getContextPath() %>/photo/list.do"
						class="a_tag_color"><div class="item">포토갤러리</div></a>
				</div>
				<div class="right_header">
					...
					<a href="<%=request.getContextPath() %>/login.do" class="login_a"><div
							class="item">로그인</div></a>
					<div class="bar">&#124;</div>
					<a href="${path }/user/join.do" class="join_a"><div
							class="item">회원가입</div></a> <a
						href="<%= request.getContextPath()%>/board/write.do"><button
							class="header_write_btn">글쓰기</button></a>
				</div>
			</div>
		...
		<div class="AccompanyId">
			<div class="InnerSection_AreaLeft">
				<div class="AccompanyContainer">
					...
					<p class="AccompanyContainer_ContentBox">${vo.content }</p>
					...
					<div class="AccompanyContainer_BottomBox">
						<p class="AccompanyContainer_PreventDrag">작성일 : ${vo.wdate } ,
							조회수 : ${vo.hit }</p>
					...
					<c:if test="${login.name == vo.writer}">
						<button class="modify"
							onclick="location.href='modify.do?bidx=${vo.bidx}'">수정하기</button>
	...
	<footer class="footer">
		...
		<div class="footer_calling">
			...
			<div class="consulting">실시간 채팅상담 매일 09:00 ~ 24:00 친절 유선 상담 평일
				10:00 ~ 19:00 (12:00-13:00) 제외</div>
		</div>
		<div class="team_info">
			<span>프로젝트 데이오프</span> <span class="margin_left">팀원 오건</span> <span
				class="margin_left">팀원 김은준</span> <span class="margin_left">팀원
				김충언</span> <span class="margin_left">팀원 임낙훈</span>
		</div>
		<div class="footer_addr">
			<span>즉시취업 신고번호 2022-09-19-전주이젠-0919</span> <span class="margin_left">전라북도
				전주시 덕진구 금암1동 667-52</span> <span class="margin_left">ogeon@gmail.com</span>
		</div>
		<div class="footer_terms">
			<span class="gray">개인정보 처리방침</span> <span class="margin_left">이용약관</span>
			<span class="margin_left">위치기반 서비스 이용 약관</span> <span
				class="margin_left">취소 및 환불정책</span> <span class="margin_left">파트너
				입점</span>
		</div>
