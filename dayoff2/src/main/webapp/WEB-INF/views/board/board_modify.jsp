...
<meta charset="UTF-8">
   <title>게시글 수정하기</title>
    ...
    />
    <link href="${path }/resources/css/board_modify.css" rel="stylesheet" />
    <link
        ...
        <div class="InnerSection_AreaLeft">
          <div class="AccompanyContainer">
            <div class="AccompanyContainer_TitleBox">
              ...
              <input type="text" class = "input_tag" name = "title" value = "${vo.title }"></p>
            </div>
            ...
            <p class="AccompanyContainer_ContentBox">
              <textarea name="content" class="textarea_tag">${vo.content }</textarea>
            </p>
              ...
              <div>
                <div class="badge_HashTag1">
                  <div>
                    ...
                    >
                      <p class="HashTag">#</p>
                      <p class="HashTag"><input type="text" name ="hashTag" value="${vo.hashTag }"></p>
                    </div>
                    </div>
                  </div>
                </div>
